...
export const DAMSidebar: React.FC<Props> = ({
  activePath,
  onNavigate,
  folders,
  collections,
  ...
  return (
    <aside className="w-[180px] shrink-0 bg-white border-r border-[#569DFF]/20 overflow-y-auto py-[16px] flex flex-col gap-[4px]">
                    ...
                    >
                      {folder.children.length > 0 && (
                        <img
                          src={ArrowDown}
                          className={`w-[10px] h-[10px] transition-transform ${
                            expandedYears.includes(folder.year)
                              ? ''
                              : '-rotate-90'
                          }`}
                        />
      ...
      <div className="mt-[4px]">
        <div className="px-[16px] py-[8px] text-[12px] font-bold text-[#94A3B8] uppercase tracking-wider">
          Collections
        </div>
      ...
      <div className="mt-[4px] border-t border-[#F1F5F9] pt-[4px]">
        <div className="px-[16px] py-[8px] text-[11px] font-bold text-[#94A3B8] uppercase">
          Categories
        </div>
